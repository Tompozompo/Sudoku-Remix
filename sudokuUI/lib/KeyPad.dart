...
class KeyPadCell extends StatelessWidget {
  ...
  bool isEnabled(SudokuModel model) {
    return model.enabledKeyPadCell[number - 1];
  }

  String getCount(SudokuModel model) {
    return model.numberCounts[number - 1].toString();
  }
}
