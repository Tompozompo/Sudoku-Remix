...
{
    [Serializable]
    public class KnightsPuzzle : ClassicPuzzle
    {
        ...
        public KnightsPuzzle(int size, int internalSize) : base(size, internalSize)
        {
            SetRules();
        }
        ...
        {
            return new KnightsPuzzle(Size, InternalSize);
        }
