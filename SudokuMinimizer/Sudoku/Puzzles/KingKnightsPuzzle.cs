...
{
    [Serializable]
    public class KingKnightsPuzzle : ClassicPuzzle
    {
        ...
        public KingKnightsPuzzle(int size, int internalSize) : base(size, internalSize)
        {
            SetRules();
        }
        ...
        {
            return new KingKnightsPuzzle(Size, InternalSize);
        }
